         ...
         <form id="admin-form" method="post" action="" role="form">
            <div class="col-xs-12">
               <div class="form-group">
                  ...
                  <a href="new-slider.php" class="btn btn-submit"><small><i class="fa fa-plus"></i></small> Thêm mới</a>
               ...
               <table class="table table-bordered table-hover">
                  ...
                  <tbody>
                     <tr>
                        ...
                        <td>
                           <a href="new-slider.php"><img class="img-thumbnail" src="../uploads/images/1.jpg" alt=""></a>
                        </td>
                        <td class="hidden-sm hidden-xs">Đoạn nội dung trình bày trên slider 1</td>
                        <td class="hidden-xs">Trang sản phẩm</td>
                         <td>
                        <a href="new-slider.php"><i class="fa fa-edit" data-toggle="tooltip" data-placement="top" title="Sửa slide"></i></a>
                        </td>
                        <td>
                     ...
                     <tr>
                        ...
                        <td>
                           <a href="new-slider.php"><img class="img-thumbnail" src="../uploads/images/2.jpg" alt=""></a>
                        </td>
                        ...
                        <td>
                           <a href="new-slider.php"><img class="img-thumbnail" src="../uploads/images/3.jpg" alt=""></a>
                        </td>
                        ...
                        <td>
                           <a href="new-slider.php"><img class="img-thumbnail" src="../uploads/images/4.jpg" alt=""></a>
                        </td>
